...
Алгоритмы (не в общем виде, то, что можно было упростить ([например](https://en.wikipedia.org/wiki/RSA_cryptosystem#:~:text=The%20smallest%20%28and%20fastest%29%20possible%20value%20for%20e%20is%203)), упрощено):
...
В ходе выполнения работы я (мы) разработали требования (в виде тестов) к ПО, разработали тест-кейсы, разработали автоматизированные тесты, разработали ПО, провели автоматизированное тестирование, провели ручное тестирование, написали отчёт. Применялось ручное и автоматизированное тестирование, позитивное, негативное, граничное тестирование, тестирование пользовательского интерфейса. Для отладки использовались техники остановки выполнения программы с помощью соответствующих инструментов и просмотр данных в выполняемой программе (см. отчёт).
